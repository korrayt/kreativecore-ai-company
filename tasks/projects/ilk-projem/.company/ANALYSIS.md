# OC — Yerel-First Kişisel AI Çalışma Alanı — Initial Analysis
...
Kullanıcının projelerini, dosyalarını, fikirlerini ve görevlerini tek bir masaüstü çalışma alanında yöneten; internet bağlantısı olmasa da temel işlevlerini sürdürebilen; yerel yapay zekâ modelleriyle çalışan güvenli ve modüler bir kişisel AI sistemi geliştirmek.

## Desired outcome

Windows üzerinde çalışan kurulum yapılabilir bir masaüstü uygulaması; yerel model bağlantısı, proje hafızası, dosya okuma, görev planlama, izin kontrollü araç kullanımı ve açık hata davranışına sahip çalışan bir MVP.

## Missing / uncertain information

- İlk analiz için yeterli temel bilgi var.
